...
long double getLForVector(std::vector<std::vector<long double>> matrix, std::vector<long double> v);
...
long double getLambdaStep(std::vector<std::vector<long double>> matrix, long double eps, int maxIter);
long double getLambdaBackIter(std::vector<std::vector<long double>> matrix, long double m, long double eps, int maxIter);
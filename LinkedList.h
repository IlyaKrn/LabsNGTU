...
LinkedList<T>::~LinkedList() {
    ...
    while (cur != nullptr) {
        ...
        //здесь должна освобождаться память, но
        //из-за вложенности списков она уже
        //освобождается, т.к деструктор вложенных
        //списков вызывается раньше этого
        //по-этому возникает ошибка.
        //Сделал вообще без удаления
//        delete cur;
        cur = next;
    }
}
